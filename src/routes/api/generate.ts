...
> = {
  ...
  generic: {
    ...
    description: 'A clean, original product concept generated by Purple',
    primaryAction: 'Get started',
  },
}
  ...
  try {
    ...
    const spec: DesignSpec = {
      ...
      description: str(
        parsed.description,
        160,
        'A clean, original product concept generated by Purple',
      ),
